    ...
    <View
        style={[
            styles.iconContainer,
            {
                ...
                padding: padding,
                borderRadius: (size + padding * 2) / 2, // Ensures perfect circle
            },
        ]}
    >
        ...
        6.498.974 12.995 1.624 19.818 1.624 9.421 
        0 18.843-1.3 27.614-3.573-48.081-9.747-84.143-51.98-84.143-102.985v-1.299 
